...
def randInt(minVal=0, maxVal=100):
    ...
    if maxVal < 0 or minVal > maxVal:
        ...
        num = ( random.random() * (maxVal - minVal) + minVal )  # its like mutliplying by percentage
...
print(
    randInt(minVal=50, maxVal=500)
)  # should print a random integer between 50 and 500
print(randInt(maxVal=-1))  # wrong parameters
print(randInt(minVal=50, maxVal=20))  # wrong parameters
